...
public class Main {
    ...
    private static final String password = "Zuber4545";
    ...
    private static void reserveRoom(Connection connection, Scanner scanner) {
        try {
            ...
            String sql = "INSERT INTO reservations (name, room_num, contact_num) " +
    ...
    private static void viewReservations(Connection connection) throws SQLException {
        String sql = "SELECT id, name, room_num, contact_num, date FROM reservations";
        ...
        try (Statement statement = connection.createStatement();
            ...
            while (resultSet.next()) {
                ...
                String reservationDate = resultSet.getTimestamp("date").toString();
